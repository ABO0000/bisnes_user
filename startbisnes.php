...
<html lang="en">
  ...
  <body style="display:flex;justify-content: center;align-items: center; " !important>
    <div id="login-box">
      <h1 style="text-align: center;margin-left:25px;margin-top:5px">Create Your Bisnes</h1>
    <div  style="margin-top: 17px;" >
      
    <form class='login-email' method="post" action="config.php" style="text-align:center ;margin-left:35%">
        <input type="hidden" name="bisnes">
      <div class='input-group'>
        ...
        <input style="margin-bottom: 5px;" type="text" onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode==10)" minlength="2" maxlength="16" id='naem' placeholder="Bisnes Name" name='name'  value="<?php isset($data['name']) ? print $data['name'] : '' ; ?>">
      </div>
      <div class='input-group'>
        ...
        <input style="margin-bottom: 5px;" type='text' onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode==10)" minlength="2" maxlength="16" placeholder="Categoria" name='categoria' value="<?php isset($data['categoria']) ? print $data['categoria'] : '' ; ?>">
      </div>
      <div class='input-group'>
      ...
      <div class='input-group' style="width: 220px;">
        <input  type="submit" name="signup_submit" value="Create Bisnes" style="margin-top: 5px;"/>
